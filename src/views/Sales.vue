<template>
  <ion-page>
    <ion-content class="ion-padding">
        ...
        <div class="col-xl-9">
          <div class="card mb-2 py-1">
            ...
            <div class="row g-2 card-header position-relative align-items-center py-2">
              ...
              <div class="col-md-3">
                <form @submit.prevent="inputSearchProduct.trim() != '' && fatchSearchDataProduct(true, true)">
              ...
              <div class="col-md-4 d-flex justify-content-end">
                ...
                <button class="btn btn-info btn-sm ms-2" type="button" @click="openModalCreateTicketOrder()">
                ...
                <button class="btn btn-outline-warning ms-2" type="button" @click="openModalListPromoBundling()">
                    ...
                    <div v-else>
                      ...
                      <div v-else>
                        <strong class="fs-0 text-warning mb-0 text-center">
                          ...
                          <del class="text-secondary fs-0">{{ $root.formatPrice(product.all_product_price[0].price) }}</del>
                        </strong>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: 100%; overflow: hidden scroll;">
                    <div class="simplebar-content p-3 p-xl-0">
                      ...
                      <form @submit.prevent="findDiscountVoucher()" class="input-group mb-3">
                        <input v-model="inputDiscountVoucher" class="form-control" type="text" placeholder="Voucher code" required>
      ...
      <!-- Canvas List Product In Order -->
      <div class="offcanvas offcanvas-end" id="offcanvasListOrderProduct" data-bs-scroll="true" tabindex="-1" aria-labelledby="offcanvasListOrderProductLabel">
        <div class="offcanvas-header align-items-start pb-0">
          <h5 class="offcanvas-title mb-0" id="offcanvasListOrderProductLabel">
            Order item list
            <p class="fs--1 m-0">
              {{ dataProductInList.length > 0 ? dataProductInList.length : '0' }} item{{ dataProductInList.length > 1 ? 's' : '' }} <span v-if="dataProductInList.length > 0">({{ totalPcsItemOrder }} pcs)</span>
            </p>
          </h5>
        ...
        <div class="offcanvas-body pt-0">
          <div class="text-end">
            <a href="javascript:void(0)" class="fs--1 mb-1 text-danger" @click="emptyProductList()"><u>Remove <span class="fas fa-trash-alt"></span></u></a>
          </div>

          <div class="text-center border-top border-400" v-if="!dataProductInList || dataProductInList.length === 0">
            <img class="pt-4 pb-1" src="@/assets/img/mtsiconland.png" width="200" alt="" />
          ...
          <div class="d-none d-md-block">
            <div v-for="(data, index) in dataProductInList" :key="index" class="row border-bottom border-top border-400 py-2">
              ...
              <div class="col-12 mt-2">
                ...
                <p class="d-flex justify-content-between align-items-center my-0">
                  <div>
                    <a v-if="data.is_ticket || data.is_promo_bundling" href="javascript:void(0)" class="p-0 fs--1 text-secondary" style="cursor: not-allowed;">
                      Remove
                    </a>
...
import { IonPage, IonInfiniteScroll, IonInfiniteScrollContent } from '@ionic/vue';

import LoadingBlack from '@/views/components/LoadingBlack.vue';
...
export default {
  components: { IonPage, IonInfiniteScroll, IonInfiniteScrollContent },
  name: 'Sales',
  data() {
    return {
  ...
  methods: {
    clickScrollToChecout: function(){
      const targetElement = document.getElementById('checkoutDetailPanelSales');
      if (targetElement) {
    ...
    infiniteLoopingDataProduct: async function(event){
      try{
        if(this.isSearchFormProduct){
          await this.fatchSearchDataProduct();
        }else{
    ...
    fatchSearchDataProduct: async function(isClearList = false, isLoading = false){
      if(isLoading) this.$root.showLoading();
      try{
        if(isClearList) {
